...
//     if (temperature < 26.0) {
//       digitalWrite(relay1Pin, HIGH);  // Relay 1 mati
//       digitalWrite(relay2Pin, LOW); // Relay 2 menyala
//       Serial.println("Kipas 1: Mati");
//       Serial.println("Kipas 2: Menyala");

//     } else {
//       digitalWrite(relay1Pin, LOW);  // Relay 1 menyala
//       digitalWrite(relay2Pin, LOW);  // Relay 2 menyala
...
//     if (temperature < 26.0) {
//       digitalWrite(relay1Pin, HIGH); // Relay 1 mati
//       digitalWrite(relay2Pin, HIGH); // Relay 2 mati
//       Serial.println("Kipas 1: Mati");
